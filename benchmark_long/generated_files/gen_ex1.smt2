...
(assert (not(=    
 (bvmul (concat (concat (concat (concat #b00000000 v1) v1) v2) v3) 
        (concat (concat (concat (concat #b00000000 v4) v5) #b00) v6) )

 (bvadd  (concat         (bvmul $e1 $e4)     #b000000000000)
 ...
 (bvadd  (concat (concat #b0000 (bvmul $e2 $e4)) #b00000000)

 (bvadd  (concat (concat #b000000 (bvmul $e1 $e6)) #b000000)
 (bvadd  (concat (concat #b000000 (bvmul $e2 $e5)) #b000000)
 (bvadd  (concat (concat #b000000 (bvmul $e3 $e4)) #b000000) 

 (bvadd  (concat (concat #b00000000 (bvmul $e1 $e6)) #b0000)
 (bvadd  (concat (concat #b00000000 (bvmul $e3 $e5)) #b0000)

 (bvadd  (concat (concat #b0000000000 (bvmul $e2 $e6)) #b00)

         (concat         #b000000000000    (bvmul $e3 $e6) )

 ))))))))))))))


; Adding new assert
(assert(let ((a!1 (bvadd (concat (bvmul (concat #b00 v1) (concat #b00 v4)) #x000)
                  (concat #b00
                  ...
                  (concat #b00
                          ...
                          #b0000000000)
                  (concat #x0 (bvmul (concat #b00 v1) (concat #b00 v5)) #x00)
                  (concat #x0 (bvmul (concat #b00 v2) (concat #b00 v4)) #x00)
                  (concat #b000000
                  ...
                  (concat #b000000
                          ...
                          #b000000)
                  (concat #b000000
                          (bvmul (concat #b00 v3) (concat #b00 v4))
                          #b000000)
                  (concat #x00 (bvmul (concat #b00 v1) (concat #b00 v6)) #x0)
                  (concat #x00 (bvmul (concat #b00 v3) (concat #b00 v5)) #x0)
                  (concat #b0000000000
                          (bvmul (concat #b00 v2) (concat #b00 v6))
                          #b00)
                  (concat #x000 (bvmul (concat #b00 v3) (concat #b00 v6)))))
