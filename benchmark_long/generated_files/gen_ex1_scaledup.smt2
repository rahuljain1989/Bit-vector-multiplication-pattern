...
(assert (not(=    
 (bvmul (concat (concat (concat (concat #b0000000000000000 v1) v1) v2) v3) 
        (concat (concat (concat (concat #b0000000000000000 v4) v5) #b0000) v6) )

 (bvadd  (concat         (bvmul $e1 $e4)     #b000000000000000000000000)

 (bvadd  (concat (concat #b0000 (bvmul $e1 $e5)) #b00000000000000000000)
 (bvadd  (concat (concat #b0000 (bvmul $e1 $e4)) #b00000000000000000000)

 (bvadd  (concat (concat #b00000000 (bvmul $e1 $e5)) #b0000000000000000)
 (bvadd  (concat (concat #b00000000 (bvmul $e2 $e4)) #b0000000000000000)

 (bvadd  (concat (concat #b000000000000 (bvmul $e1 $e6)) #b000000000000)
 (bvadd  (concat (concat #b000000000000 (bvmul $e2 $e5)) #b000000000000)
 (bvadd  (concat (concat #b000000000000 (bvmul $e3 $e4)) #b000000000000) 

 (bvadd  (concat (concat #b0000000000000000 (bvmul $e1 $e6)) #b00000000)
 (bvadd  (concat (concat #b0000000000000000 (bvmul $e3 $e5)) #b00000000)

 (bvadd  (concat (concat #b00000000000000000000 (bvmul $e2 $e6)) #b0000)

         (concat         #b000000000000000000000000    (bvmul $e3 $e6) )

 ))))))))))))))


; Adding new assert
(assert(let ((a!1 (bvadd (concat (bvmul (concat #x0 v1) (concat #x0 v4)) #x000000)
                  (concat #x0 (bvmul (concat #x0 v1) (concat #x0 v5)) #x00000)
                  (concat #x0 (bvmul (concat #x0 v1) (concat #x0 v4)) #x00000)
                  (concat #x00 (bvmul (concat #x0 v1) (concat #x0 v5)) #x0000)
                  (concat #x00 (bvmul (concat #x0 v2) (concat #x0 v4)) #x0000)
                  (concat #x000 (bvmul (concat #x0 v1) (concat #x0 v6)) #x000)
                  (concat #x000 (bvmul (concat #x0 v2) (concat #x0 v5)) #x000)
                  (concat #x000 (bvmul (concat #x0 v3) (concat #x0 v4)) #x000)
                  (concat #x0000 (bvmul (concat #x0 v1) (concat #x0 v6)) #x00)
                  (concat #x0000 (bvmul (concat #x0 v3) (concat #x0 v5)) #x00)
                  (concat #x00000 (bvmul (concat #x0 v2) (concat #x0 v6)) #x0)
                  (concat #x000000 (bvmul (concat #x0 v3) (concat #x0 v6)))))
