...
run the other solvers in a separate process on the newly generated formula. The time taken to run our matching algorithms and generate the new formula is less than one second across all our benchmarks, and hence is not reported. We use the following versions of the solvers: $\zthree$(4.4.2), $\boolector$(2.2.0), $\cvcfour$(1.4).
% %
