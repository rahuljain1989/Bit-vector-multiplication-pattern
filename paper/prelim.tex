...
\end{tabular}
\end{center}
The following is a combination of the partial products using 
...
%
In contrast to the above tabular representation, we cannot concatenate 
two partial products next to each other.
