...
summed, while half adders are used if there are only two bits remain
to be summed.
%
...
Note that neither a long multiplier nor a Wallace tree multiplier
completely specifies the implementation.
%
